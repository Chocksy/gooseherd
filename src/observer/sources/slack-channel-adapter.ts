/**
 * Slack Channel Adapter — parses alert messages from monitored Slack channels
 * into TriggerEvents.
 *
 * Identifies alert bot messages (Sentry, PagerDuty, Datadog) by bot_id
 * and extracts actionable information from their structured content.
 */
